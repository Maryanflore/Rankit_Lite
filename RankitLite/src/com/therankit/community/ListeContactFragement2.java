...
public class ListeContactFragement2 extends Fragment implements OnItemClickListener {
	private String TAG = ListeContactFragement2.class.getSimpleName();
...
//Toast.makeText(getActivity(), "Partager" +date, Toast.LENGTH_SHORT).show();
		final Intent MessIntent = new Intent(Intent.ACTION_SEND);
        	...
        	ListeContactFragement2.this.startActivity(Intent.createChooser(MessIntent, "Inviter avec..."));
        }
