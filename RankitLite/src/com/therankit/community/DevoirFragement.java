...
public class DevoirFragement extends Fragment implements OnItemClickListener {
	private String TAG = DevoirFragement.class.getSimpleName();
...
List<String> descriptionPetitNews= new ArrayList<String>() ;
 ...
 public void contact() throws JSONException
 {
	 ...
	 for(int i=0;i<4;i++)
	 {
		 ...
		 if(i==0)
		 {
			 objContact0.setPhoneNo(getString(R.string.dvr1));

		 }
		 else if(i==1)
		 {
			 objContact0.setPhoneNo(getString(R.string.dvr2));

		 }

		 else if(i==2)
		 {
			 objContact0.setPhoneNo(getString(R.string.dvr3));

		 }
		 else if(i==3)
		 {
			 objContact0.setPhoneNo(getString(R.string.dvr4));
		...
		switch (item.getItemId()) {
			...
			case R.id.action_icon_info:
				...
				new MaterialDialog.Builder(getActivity())
						.title("Information")
						.content(getString(R.string.info_devoir_conso))
						.positiveText("OK")
...
//Toast.makeText(getActivity(), "Partager" +date, Toast.LENGTH_SHORT).show();
		final Intent MessIntent = new Intent(Intent.ACTION_SEND);
        	...
        	DevoirFragement.this.startActivity(Intent.createChooser(MessIntent, "Inviter avec..."));
        }
