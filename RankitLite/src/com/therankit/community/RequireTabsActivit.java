...
public class RequireTabsActivit extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFrag(new RequireFragement(), "");
    ...
    public void selectDrawerItem(MenuItem menuItem) {
        ...
        switch (menuItem.getItemId()) {
            ...
            case R.id.CommunityHome:
                Intent intentCommunity = new Intent(getBaseContext(), RequireTabsActivit.class);
