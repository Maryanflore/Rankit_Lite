...
public class DroitFragement extends Fragment implements OnItemClickListener {
	private String TAG = DroitFragement.class.getSimpleName();
...
//Toast.makeText(getActivity(), "Partager" +date, Toast.LENGTH_SHORT).show();
		final Intent MessIntent = new Intent(Intent.ACTION_SEND);
        	...
        	DroitFragement.this.startActivity(Intent.createChooser(MessIntent, "Inviter avec..."));
        }
