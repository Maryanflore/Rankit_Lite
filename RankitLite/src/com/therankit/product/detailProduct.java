...
public class detailProduct extends AppCompatActivity {
	private String TAG = detailProduct.class.getSimpleName();
   ...
   public void onCreate(Bundle savedInstanceState) {
    ...
    int id_lastService=0;
	 ...
	 serviceBdd.close();
   	 ...
   	 adapter=new ListViewAdapter2(getApplicationContext(),detailProduct.this, grpBr);
										 ...
										 Intent broadcastIntent = new Intent();
      						        	...
      						        	// result.setText(getApplicationContext().getString(R.string.msg_after_vote));
      						        	 //result.setTextColor(Color.parseColor("#000000"));
											new MaterialDialog.Builder(detailProduct.this)
