...
public class BestServicesAdapter extends ArrayAdapter<BestServicesBean> {

	private Activity activity;
	private List<BestServicesBean> items;
	private int row;
	private BestServicesBean objBean;
    public ImageLoaderProfil imageLoader;
    public int emotion_nbre;

	public BestServicesAdapter(Activity act, int row, List<BestServicesBean> items) {
		super(act, row, items);
        this.emotion_nbre=2;
		this.activity = act;
		this.row = row;
