...
@SuppressLint("NewApi")
public class detailService_old extends AppCompatActivity {
	private String TAG = detailService_old.class.getSimpleName();
   ...
   public void onCreate(Bundle savedInstanceState) {
	 ...
	 //imageText.setImageUrl(Const.ipUriLogo+entreprise_logo, imageLoader);
		 Picasso.with(this).load(Const.ipUriLogo+entreprise_logo).centerCrop().fit().into(imageText, new Callback() {
			 @Override
    ...
    int id_lastService=0;
	 ...
	 serviceBdd.close();
   	 ...
   	 adapter=new ListViewAdapter2(getApplicationContext(),detailService_old.this, grpBr);
...
makeJsonObjReq(jsonObjSend,""); 
	...
	private void setupWindowAnimations() {
		...
		public void onBackPressed() {
			...
			if(!etatVote)
			{
			AlertDialog.Builder builder = new AlertDialog.Builder(detailService_old.this);
