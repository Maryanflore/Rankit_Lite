...
public class detailService  extends AppCompatActivity {
	private String TAG = detailService.class.getSimpleName();
	...
	private Boolean fabVote=false;
	 @Override
   public void onCreate(Bundle savedInstanceState) {
       super.onCreate(savedInstanceState);
       setContentView(R.layout.detail_critere_notation2);
	 ...
	 //imageText.setImageUrl(Const.ipUriLogo+entreprise_logo, imageLoader);
		 Picasso.with(this).load(Const.ipUriLogo2+entreprise_logo).centerCrop().fit().into(imageText, new Callback() {
			 @Override
	 ...
	 imageText.setOnClickListener(new View.OnClickListener() {
   	    ...
   	    /* Intent intent = new Intent(detailService.this, detail_entreprise_service.class);
    ...
    int id_lastService=0;
	 try {
		 JSONArray	 jsonArrayServices=serviceBdd.getListServices(settings.getString("langue", "en"),Integer.parseInt(secteur_id),entreprise_id);
	 ...
	 serviceBdd.close();
   	 ...
   	 adapter=new ListViewAdapter2(getApplicationContext(),detailService.this, grpBr);
	  ...
	  */
	   ...
	   if(settings.getString("sourceNoteS", "0").equals("1"))
    	...
    	//creation de la BD
		 ...
		 textToolHeader.setText(" "+entreprise_name);
...
makeJsonObjReq(jsonObjSend,""); 
										 ...
										 Intent broadcastIntent = new Intent();
      						        	...
      						        	// result.setText(getApplicationContext().getString(R.string.msg_after_vote));
      						        	 //result.setTextColor(Color.parseColor("#000000"));
											new MaterialDialog.Builder(detailService.this)
													.content(getApplicationContext().getString(R.string.msg_after_vote))
													.positiveText("OK")
		...
		private void ListeServices(int idLastService)
		  {
			  try
				...
				{  	showProgressDialog();
					...
					jsonObjSend.put("type_critere",Const.TYPE_SERVICE);
						...
						for(int i=0;i< grpBr.size() ;i++)
						 {
							...
							{ 
								...
								notes.put("critere_id", grpBr.get(i).getIdService());
								notes.put("critere_notes", grpBr.get(i).getNoteService());
	...
	private void setupWindowAnimations() {
		...
		public void onBackPressed() {
			...
			if(!etatVote)
			{
			AlertDialog.Builder builder = new AlertDialog.Builder(detailService.this);
