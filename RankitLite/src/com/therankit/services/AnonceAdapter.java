...
public class AnonceAdapter extends BaseAdapter {
        ...
        public AnonceAdapter(Activity a, int rowTourne,ArrayList<AnonceRow> grpBr, OnClickListener onClick) {
        		activity = a; 
                liste = grpBr;
                click = onClick; 
                idView = rowTourne;
		...
		public View getView(int position, View view, ViewGroup parent) {
                if (view == null) {
                        ...
                        holder.barr_vote = (ImageView)view.findViewById(R.id.barr_vote);
                        ...
                        holder.rowImageProfil.setOnClickListener(click); 
                        holder.rowNomPublieur.setOnClickListener(click);
                        holder.barr_vote.setOnClickListener(click);
                        view.setTag(holder);
                } else {
                        holder = (HolderAnonce) view.getTag();
                }
